#ifndef RIC_PNGENCODER_HPP
#define RIC_PNGENCODER_HPP
#if _MSC_VER > 1000
#pragma once
#endif
...
class PNGEncoder:public RF_Encoders::ImageEncoder
{
public:
    PNGEncoder();

    static const RF_Type::UInt32 FOURCC;
